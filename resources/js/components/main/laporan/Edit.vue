...
export default {
  ...
  data() {
    return {
      model: {
        file_name: this.laporan.file_name ?? "",
        file_file: this.laporan.file_link ?? "",
        title: this.laporan.title ?? "",
        title_indo: this.laporan.title_indo ?? "",
        description: this.laporan.description ?? "",
        description_indo: this.laporan.description_indo ?? "",
        is_internal: this.laporan.is_internal ?? "",
      },
      valid: false,
      isRequest: false,
      alert: true,
    ...
    save(content) {
      ...
      if (!self.isRequest && self.isValid) {
        const data = {
          ...
          is_internal: self.model.is_internal,
          id: self.laporan.id,
        };
        self.isRequest = true;
        self.$store
