                    ...
                    <div class="footer-widget widget-links">
                        ...
                        <div class="widget-content">
                            <ul>
                                ...
                                <li><a href="{{ route('customer-relationship') }}">Customer Relationship</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="footer-widget widget-contact">
                        <div class="widget-content">
                            <ul>
                                ...
                                <li class="email">Email: <a href="mailto:pinjaman@kopkarkbn.com">pinjaman@kopkarkbn.com</a></li>
                                <li class="address">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="footer-copyright">
                        <div class="copyright"><span>&copy; 2022 Koperasi KBN. all rights reserved. </span>
