...
@push('title')
<title>Koperasi KBN - Suara Anggota - Customer Relationship</title>
@endpush
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-5">
                        <div class="title">
                            <h1 class="title-heading">Customer Relationship</h1>
        ...
        <div class="breadcrumb-wrap">
            <div class="container">
                <ol class="breadcrumb d-flex">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Customer Relationship</li>
                </ol>
                <!-- End .row-->
            </div>
        </div>
