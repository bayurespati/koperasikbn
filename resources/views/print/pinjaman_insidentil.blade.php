                ...
                <div class="col-12">
                    <table class="table mb-0">
                        <tbody>
                            ...
                            <tr style="padding: 0 0 4px 0;">
                                <td style="width: 250px; padding: 0">
                                    <h5 style="font-weight: normal;">GAJI</h5>
                                </td>
                                <td style="padding: 0">
                                    <h5 style="font-weight: normal;">: Bayu Respati</h5>
                                </td>
            ...
            <div class="row">
                <div class="col-12">
                    <h5 style="font-weight: normal; margin-top: 10px" align="justify">
                        Mohon diberikan Pinjaman Insidentil sebesar Rp. <span style="font-weight: bold; text-transform: uppercase">{{"10.000.000"}}</span>, yang akan saya pergunakan
