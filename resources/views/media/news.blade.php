...
@push('title')
<title>Koperasi KBN - Media - Berita</title>
@endpush
                ...
                <div class="col-12 col-md-6 col-lg-4 project-item filter-{{ $datum->category }}">
                    <div class="project-panel">
                        <div class="project-panel-holder">
                            <div class="project-img"><a class="link" href="news/{{ $datum->id }}"></a><img src="/{{ $datum->image_link }}" alt="{{ $datum->image_name }}" /></div>
                            <!-- End .project-img-->
                            <div class="project-content">
                                <div class="project-cat"><a href="news/{{ $datum->id }}">{{ $datum->category }}</a>
                                </div>
                                <div class="project-title">
                                    @if(Cookie::get('current_lang') == 'eng')
                                    <h4><a href="news/{{ $datum->id }}">{{ $datum->title }}</a></h4>
                                    @else
                                    <h4><a href="news/{{ $datum->id }}">{{ $datum->title_indo }}</a></h4>
                                    @endif
                                </div>
                                ...
                                @if(Cookie::get('current_lang') == 'eng')
                                <div class="project-more"> <a class="btn btn--bordered btn--white" href="news/{{ $datum->id }}">More <i class="energia-arrow-right"></i></a></div>
                                @else
                                <div class="project-more"> <a class="btn btn--bordered btn--white" href="news/{{ $datum->id }}">Selengkapnya <i class="energia-arrow-right"></i></a></div>
                                @endif
                            </div>
                            <!-- End .project-content -->
                        </div>
