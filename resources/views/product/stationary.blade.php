                ...
                <div class="title">
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <h1 class="title-heading">Alat Tulis Kantor (ATK)</h1>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="col-12">
                        <div class="breadcrumb-wrap">
                            <ol class="breadcrumb breadcrumb-light d-flex">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Alat Tulis Kantor (ATK)</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="widget widget-services">
                            ...
                            <div class="widget-content">
                                <ul class="list-unstyled">
                                    ...
                                    <li class="custom-active-widget"><a href="#"> <span>Alat Tulis Kantor (ATK)</span></a></li>
